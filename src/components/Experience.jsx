  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        ...
        "Blockchain Platforms: Ethereum, Solana, Polygon, Hyperledger",
        "Libraries: Web3.js, Ethers.js, ZoKrates (for zk-SNARKs), OpenZeppelin (for smart contract security)",
        "Smart Contract Development: Solidity, Rust (for Solana){Learning}",
        ...
        "Oracles: Chainlink",
        "DevOps & Cloud: Docker, AWS, Heroku, Netlify",
